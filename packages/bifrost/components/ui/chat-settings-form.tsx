...
import { IconInfoCircle, IconTree } from "@tabler/icons-react"
...
export const ChatSettingsForm: FC<ChatSettingsFormProps> = ({
  ...
  const { profile, models } = useContext(BifrostContext)
...
const AdvancedContent: FC<AdvancedContentProps> = ({
  ...
  return (
    <div className="mt-5">
      ...
      <div className="mt-4 flex items-center space-x-2">
        <Checkbox
          checked={chatSettings.yggdrasilMode ?? true}
          onCheckedChange={(value: boolean) =>
            onChangeChatSettings({
              ...chatSettings,
              yggdrasilMode: value
        ...
        <IconTree size={16} className="text-emerald-500" />

        <Label>YGGDRASIL Verified Mode</Label>
        ...
        {showTooltip && (
          <WithTooltip
            ...
            display={
              <div className="w-[400px] p-3">
                <strong>YGGDRASIL Mode</strong>
                <p className="mt-1 text-sm">
                  When enabled, responses are validated through YGGDRASIL&apos;s
                  epistemic branches (MIMIR, VOLVA, HUGIN) and include source
                  citations. The AI will only respond with verified information
                  or say &quot;I don&apos;t know&quot; rather than hallucinate.
                </p>
              </div>
            }
            trigger={
